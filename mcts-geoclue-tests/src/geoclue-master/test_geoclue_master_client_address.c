...
static void test_create_address_country ()
{
...
static void test_create_address_country_code ()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
static void test_create_address_region ()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
static void test_create_address_locality ()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
static void test_create_address_area ()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
static void test_create_address_postal_code()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
static void test_create_address_street()
{
	/*wait for obtaining address*/
	wait();
	g_assert ( test_address != NULL );
...
void test_create_address_accuracy_level ()
{
...
void test_create_address_accuracy_horizontal ()
{
...
void test_create_address_accuracy_vertical ()
{
...
static void test_geoclue_master_client_create_address()
{
	GeoclueMasterClient* client = create_geoclue_master_client();
	g_assert ( client != NULL );

	GError* error = NULL;
	GeoclueAddress* address = geoclue_master_client_create_address ( client,
		&error );
	if ( error ) {
...
int main ( int argc,char **argv )
{
	...
	/*add test cases*/
	g_test_add_func (
		"/geoclue/geoclue_master_client/create_address/test_create_address",
		test_geoclue_master_client_create_address );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_country_code",\
		test_create_address_country_code );
	g_test_add_func("/geoclue/geoclue_master_client/create_address/\
		test_create_address_country",
		test_create_address_country );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_region",
		test_create_address_region );
	g_test_add_func("/geoclue/geoclue_master_client/\
		create_address/test_create_address_locality",
		test_create_address_locality );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_area",
		test_create_address_area );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_postal_code", test_create_address_postal_code );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_street",
		test_create_address_street );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_accuracy_level",\
		test_create_address_accuracy_level);
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_accuracy_horizontal",\
		test_create_address_accuracy_horizontal );
	g_test_add_func ("/geoclue/geoclue_master_client/create_address/\
		test_create_address_accuracy_vertical",\
		test_create_address_accuracy_vertical );
