...
int test_lingrad(test_execution_params * params)
{
	...
	init(pcontext);
	printf("\n--- Linear Gradient function and perf Testing with PAD model\n");
	...
	printf("\n--- Linear Gradient function and perf Testing with REPEAT model\n");
	vgSetParameteri(pcontext->vgPaint, VG_PAINT_COLOR_RAMP_SPREAD_MODE,
	...
	printf("\n--- Linear Gradient function and perf Testing with REFLECT model\n");
	vgSetParameteri(pcontext->vgPaint, VG_PAINT_COLOR_RAMP_SPREAD_MODE,
