/* wlan-core-eloop.c -- WLAN core event loop
...
void eloop_run(void)
{
...
#if 0
                        BLTS_DEBUG("\nnext timeout in %lu.%06lu sec\n",
                               tv.tv_sec, tv.tv_usec);
                        BLTS_DEBUG("readers:%d\n", eloop.reader_count);
#endif
                }
        ...
        /* set to zero -> eloop can be started again if needed */
        eloop.terminate = 0;
}
...
{
	BLTS_DEBUG("eloop terminate called\n");
    eloop.terminate = 1;
}
