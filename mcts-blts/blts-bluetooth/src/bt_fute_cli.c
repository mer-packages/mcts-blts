...
static blts_cli_testcase bt_cases[] =
{
	...
	{ "Core-Bluetooth verify class with remote HCI", bt_run_case, 10000 },
	{ "Core-Bluetooth reset connection with HCI", bt_run_case, 10000 },
	{ "Core-Bluetooth audit incoming HCI connection", bt_run_case, 10000 },
