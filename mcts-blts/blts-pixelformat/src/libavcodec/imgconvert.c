...
static const PixFmtInfo pix_fmt_info[PIX_FMT_NB] = {
    ...
    // Packed YUV formats with reduced channel precision
    [PIX_FMT_YUV444] = {
        .name = "yuv444",
        .nb_channels = 1,
        .color_type = FF_COLOR_YUV_JPEG, // Use full component range
        .pixel_type = FF_PIXEL_PACKED,
        .depth = 4,
        .x_chroma_shift = 0, .y_chroma_shift = 0,
    },
...
int avcodec_check_dimensions(void *av_log_ctx, unsigned int w, unsigned int h){
    ...
    BLTS_ERROR("picture size invalid (%ux%u)\n", w, h);
    return -1;
}
