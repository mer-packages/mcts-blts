...
extern void (*sbggr8torgb24)(const uint8_t *src, uint8_t *dst, int width, int height);
extern void (*sbggr16torgb24)(const uint8_t *src, uint8_t *dst, int width, int height);
extern void (*sgrbg10torgb24)(const uint8_t *src, uint8_t *dst, int width, int height);
extern void (*sgrbg10pixeltorgb24)(const uint8_t *src,
