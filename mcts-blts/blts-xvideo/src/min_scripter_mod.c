/* min_scripter_mod.c -- Min scripter plugin interface for XVideo tests
...
int test_presence_check(MinItemParser *args);
...
{
	ENTRYTC(*list, "test_xvideo_presence_check", test_presence_check);
	return 0;
}
